...
def chew_measure_data(src_measure_data: str) -> tuple[float, str, str]:
    if src_measure_data:
        src_quantity = first_digit_get(src_measure_data)
        src_unit = second_unit_get(src_quantity[1])
        return src_quantity[0], src_unit[0], src_unit[1]
    return 0.0, "", ""
